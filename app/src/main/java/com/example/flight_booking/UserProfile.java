...
import com.example.flight_booking.Models.All_UserMember;
...
public class UserProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivEdit=findViewById(R.id.iv_edit_cp);
                        ...
                        documentReference.set(profile)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        Toast.makeText(UserProfile.this, "Profile Created", Toast.LENGTH_LONG).show();

                                        Handler handler = new Handler();
                                        handler.postDelayed(new Runnable() {
                                            @Override
                                            public void run() {
                                                Intent intent = new Intent(UserProfile.this, BookAFlight.class);
                                                startActivity(intent);
                                            }
                                        }, 2000);
